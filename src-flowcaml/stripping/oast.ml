...
(* $Id: oast.ml,v 1.4 2003/06/26 13:32:54 simonet Exp $ *)
(* Oast: Ocaml's abstract syntax tree. *)

(* ACHTUNG !
   We assume that the types provided by the module Asttypes are the
   same in Flow Caml as in Objective Caml.
 *)
...
let flowperv = "Flowperv"
let propagate = "_propagate_"
let try_finally = "_try_finally_"
let catchable = "_catchable_"
